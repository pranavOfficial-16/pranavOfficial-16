...
• Languages & Frameworks: C++, Python, SQL, ReactJS, FastAPI <br>
• Generative AI: LLMs & APIs Integration, RAG, LangChain, LangGraph, Prompt Engineering <br>
• Voice & Conversational AI: Twilio, Text-to-Speech(TTS), Speech-to-Text(STT) <br>
• Databases: PostgreSQL, SQLite, MongoDB, Redis, Firebase, ChromaDB, Milvus <br>
• DevOps & Cloud: Docker, AWS(EC2, S3, Lambda), CI/CD <br>
